    ...
    template: `
        <div class="page page--narrow">
            ...
            <section class="card">
                ...
                <p class="small muted">
                    Everything that has happened to your account, including any occasion on which you signed in or
                    changed something.
                </p>
            ...
            <section class="card danger-zone">
                ...
                <app-banner kind="danger" title="This cannot be undone">
                    <p style="margin: 0 0 8px">
                        Deleting your account removes every campaign, every character and every conversation. There is
                        no way to get them back.
                    </p>
                    <p style="margin: 0" class="small">
                        Backups taken before now may still hold your data until they age out of the backup schedule.
                    </p>
                </app-banner>
                ...
                @if (deletionResult(); as result) {
                    ...
                    <label class="toggle">
                        <input type="checkbox" [checked]="understood()" (change)="understood.set(!understood())" />
                        <span class="small">
                    ...
                    <button type="button" class="btn btn--danger" [disabled]="!canDelete()" (click)="deleteAccount()">
...
export class AccountPage {
    ...
    private async loadActivity(): Promise<void> {
        try {
            const entries = await firstValueFrom(this.api.get<ActivityEntry[]>('/api/v1/account/activity'));
