...
const CLASSES: readonly { value: CharacterClass; label: string; blurb: string }[] = [
    {
        value: 'barbarian',
        label: 'Barbarian',
        blurb: 'Rage, endurance, and hitting things very hard.'
    },
    {
        value: 'bard',
        label: 'Bard',
        blurb: 'Talk your way in, and inspire everyone once you are there.'
    },
    ...
    { value: 'druid', label: 'Druid', blurb: 'Nature magic, and turning into animals.' },
    {
        value: 'fighter',
        label: 'Fighter',
        blurb: 'Straightforward, versatile, and very good at combat.'
    },
    { value: 'monk', label: 'Monk', blurb: 'Speed and unarmed skill over armour and weapons.' },
    {
        value: 'paladin',
        label: 'Paladin',
        blurb: 'An oath, heavy armour, and radiant force behind it.'
    },
    {
        value: 'ranger',
        label: 'Ranger',
        blurb: 'Tracking, wilderness survival, and precise shooting.'
    },
    { value: 'rogue', label: 'Rogue', blurb: 'Stealth, locks, traps, and finding the weak spot.' },
    {
        value: 'sorcerer',
        label: 'Sorcerer',
        blurb: 'Innate magic, forceful and a little unpredictable.'
    },
    {
        value: 'warlock',
        label: 'Warlock',
        blurb: 'Power borrowed from something with its own agenda.'
    },
    {
        value: 'wizard',
        label: 'Wizard',
        blurb: 'Studied magic, and the widest spell list in the game.'
    }
];

/** The six ability scores, with what each governs. */
const ABILITIES: readonly { key: keyof AbilityScores; label: string; governs: string }[] = [
    { key: 'strength', label: 'Strength', governs: 'Lifting, shoving, hitting with heavy weapons' },
    {
        key: 'dexterity',
        label: 'Dexterity',
        governs: 'Stealth, reflexes, accuracy with light weapons'
    },
    ...
    template: `
        <div class="page page--narrow">
            <header class="page__header">
                ...
                <p class="page__lead">
                    None of this is permanent — you can change any of it later, and the Dungeon Master will work with
            ...
            <form class="card" (ngSubmit)="submit()">
                <label class="field">
                    ...
                    <span class="field__hint">
                        Encrypted before storage. People often use a real name here, so it is treated as personal data
                        whatever you put.
                    </span>
                </label>
                ...
                <fieldset class="field">
                    ...
                    <p class="small muted" style="margin-top: 0">
                        These start from the standard set in the rules. 10 is average for an adult; higher is better. If
                        you are not sure, leave them alone.
                    </p>
