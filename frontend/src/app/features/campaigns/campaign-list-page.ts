        ...
        <div class="page">
            ...
            @if (loading()) {
                ...
                <div class="card empty">
                    ...
                    <p class="muted">
                        A campaign holds one ongoing story — its premise, its characters, and everything that has
                        happened so far. You can also just start playing and one will be created for you.
                    </p>
                    <div class="row">
                    ...
                    @for (campaign of campaigns(); track campaign.campaign_id) {
                        <article class="card campaign">
                            ...
                            <p class="small muted campaign__meta">
                                {{ campaign.tone | titlecase }} ·
                                {{ campaign.ruleset === 'dnd5e' ? 'D&D 5e' : 'Freeform' }} ·
                            ...
                            <div class="row row--wrap campaign__actions">
                                ...
                                <a
                                    [routerLink]="['/campaigns', campaign.campaign_id, 'characters']"
                                    class="btn btn--sm"
                                >
                                    Characters
                                </a>
