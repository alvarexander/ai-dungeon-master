...
7. **Stubbed screens must say so on screen**, using `<app-stub-notice>`. A mock
...
src/app/
  core/
    ...
    voice/                microphone recording and upload
  shared/ui/              banner, stub notice
...
| [VOICE_INPUT.md](docs/VOICE_INPUT.md) | You are touching audio, or the permission flow |
...
**Fully working:** the chat loop, voice input, campaigns, characters, settings,
account deletion, the privacy disclosure, and every screen's layout.
